...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: texto, contextInfo: { externalAdReply: { title: '𝚃𝙷𝙴 𝙼𝙰𝙺𝙰𝙽𝙰𝙺𝚈 𝙱𝙾𝚃', body: null, thumbnail: imagen1, sourceUrl: 'https://github.com/ADRIANOSANCHEZ24/BOT-MAKANAKY-GAAA' }, mentionedJid: [m.sender]}}}, aa)    
...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: texto, contextInfo: { externalAdReply: { title: '𝚃𝙷𝙴 𝙼𝙰𝙺𝙰𝙽𝙰𝙺𝚈 𝙱𝙾𝚃', body: null, thumbnail: imagen1, sourceUrl: 'https://github.com/ADRIANOSANCHEZ24/BOT-MAKANAKY-GAAA' }, mentionedJid: [m.sender]}}}, aa2)    
conn.relayMessage(m.chat, prep.message, { messageId: prep.key.id, mentions: [m.sender] })
