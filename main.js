...
return { conversation: "hello, i'm Aldo Sánchez" }},   
msgRetryCounterMap,
logger: pino({ level: 'silent' }),
auth: state,
browser: ['MakanakyBot','Safari','9.7.0'],
version   
}
...
let bio = `🤖 ᴛɪᴇᴍᴘᴏ ᴀᴄᴛɪᴠᴏ: ${uptime} ┃ 👑 ʙʏ ᴀᴅʀɪᴀɴᴏ sᴀɴᴄʜᴇᴢ ┃ 🔗 ᴄᴜᴇɴᴛᴀs ᴏғᴄ: https://www.atom.bio/adri2.pc`
